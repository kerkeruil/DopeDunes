...
// */
//public class TestBossEntityNew extends SkeletonEntity implements SmartBrainOwner<TestBossEntityNew> {
//    public static Integer ATTACK_ACTIVE = 0;
//    public TestBossEntityNew(EntityType<? extends TestBossEntityNew> entityType, World world) {
...
//
//    @Override
//    public List<? extends ExtendedSensor<? extends TestBossEntityNew>> getSensors() {
//        return ObjectArrayList.of(
//                new NearbyPlayersSensor<>(), 							// Keep track of nearby players
//                new NearbyLivingEntitySensor<TestBossEntityNew>()
...
//
//    @Override
//    public BrainActivityGroup<? extends TestBossEntityNew> getCoreTasks() {
...
//                new StrafeTarget<>().stopStrafingWhen(entity -> !isHoldingBow(entity)).startCondition(TestBossEntityNew::isHoldingBow),	// Strafe around target
//                new MoveToWalkTarget<>());																					// Move to the current walk target
//    }
//
//    @Override
//    public BrainActivityGroup<? extends TestBossEntityNew> getIdleTasks() {
//        return BrainActivityGroup.idleTasks(
//                new FirstApplicableBehaviour<TestBossEntityNew>( 				// Run only one of the below behaviours, trying each one in order. Include explicit generic typing because javac is silly
...
//
//    @Override
//    public BrainActivityGroup<? extends TestBossEntityNew> getFightTasks() {
...
//                        new BowAttack<>(20).startCondition(TestBossEntityNew::isHoldingBow),	 												 // Fire a bow, if holding one
...
//                            .attackInterval(entity -> getSwingDurationTicks(AXE_SWING_STATE))
