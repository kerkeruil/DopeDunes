...
//
//public class TestBossRendererOld extends MobEntityRenderer<TestBossEntity, TestBossModel<TestBossEntity>> {
...
//    public TestBossRendererOld(EntityRendererFactory.Context ctx) {
