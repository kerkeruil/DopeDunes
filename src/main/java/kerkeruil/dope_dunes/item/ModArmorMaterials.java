...
public enum ModArmorMaterials implements ArmorMaterial {
    RADIOACTIVE_INGOT("nuc_armor", 25, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
    }), 24, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 1.0f, 0.0f, () -> Ingredient.ofItems(ModItems.RADIOACTIVE_INGOT));
    ...
    public String getName() {
        return DopeDunes.MOD_ID + ":" + this.name;
    }
