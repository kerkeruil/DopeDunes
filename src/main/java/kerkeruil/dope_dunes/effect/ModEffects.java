...
public class ModEffects {
    ...
    private static StatusEffect registerStatusEffect(String name, StatusEffect statusEffect) {
        return Registry.register(Registries.STATUS_EFFECT, new Identifier(DopeDunes.MOD_ID, name), statusEffect);
    }

    public static void registerEffects() {
        DopeDunes.LOGGER.info("Registering Mod Effects for " + DopeDunes.MOD_ID);
    }
}
